#!/usr/bin/env python3
"""
Recupero codici sconto Lentiamo da shopilo.it
Sursa: https://shopilo.it/negozi/lentiamo.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/lentiamo.it"
STORE_NAME = "Lentiamo"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Lentiamo da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-lentiamo)"
    }
    try:
